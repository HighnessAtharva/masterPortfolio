...
<p align="center"> 
    <a href="https://highnessatharva.github.io/" target="_blank">
  </a>
</p>
...
- After the successful installation of `nodejs` and `npm`, clone the repository into your local system using below command:
  ```bash
   git clone https://github.com/HighnessAtharva/masterPortfolio.git
  ```
...
Note here that if you click [my portfolio](https://highnessatharva.github.io/), you can see animating the logo at the beginning. I have designed that logo in [`Figma`](https://www.figma.com/) and then animated it using css.
